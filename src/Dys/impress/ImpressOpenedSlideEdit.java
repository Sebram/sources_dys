...
import Dys.reveals.Slide;
import Dys.reveals.revSlideEdit;
 ...
 * @author Sebram
 */
public class ImpressOpenedSlideEdit extends javax.swing.JDialog {
   ...
   public boolean addingstate = false;
   
   public static boolean backstate;
    
    
    /** Creates new form EditSlideImpress */
    public ImpressOpenedSlideEdit(java.awt.Frame parent, boolean modal) {
        ...
        String [] titres = new String[iProject.liste_titre.size()];
            
            for(int i = 0;i<iProject.liste_titre.size();i++){
        // JOptionPane.showMessageDialog(null, iProject.liste_titre.get(i));    
                titres[i]=iProject.liste_titre.get(i);                
            
            } 
             
        comboSelectionTitre.setModel(new javax.swing.DefaultComboBoxModel(titres));
        ...
        if(comboSelectionTitre.getSelectedIndex() != -1)        
            ind = comboSelectionTitre.getSelectedIndex();               

        jTextArea1.setText(iProject.getText(ind));

        jComboBox2.setSelectedItem(iProject.getTime(ind));

        jTextField2.setText(iProject.getId(ind));

        fieldPosX.setText(iProject.getPosX(ind));

        fieldPosY.setText(iProject.getPosY(ind));

        jTextField1.setText(iProject.getPosZ(ind));

        fieldRotate.setText(iProject.getRotate(ind));

        fieldRotaX.setText(iProject.getRotateX(ind));

        fieldRotaY.setText(iProject.getRotateY(ind));

        fieldScale.setText(iProject.getScale(ind));

        fieldSlideTitle.setText(iProject.getTitle(ind));

        jComboBox4.setSelectedItem(iProject.getTheme(ind));

        comboSelectionTitre.setSelectedItem(iProject.getTitle(ind));
        
        bg = iProject.getBg(ind);

        img = iProject.getImg(ind);
        

        jLabel16.setVisible(true);

        comboSelectionTitre.setVisible(true);
    ...
    private void initComponents() {
        ...
        comboSelectionTitre = new javax.swing.JComboBox();
        ...
        comboSelectionTitre.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        comboSelectionTitre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboSelectionTitreActionPerformed(evt);
            }
        });
        comboSelectionTitre.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                comboSelectionTitreFocusGained(evt);
            }
        });

        jLabel16.setText("Séléctionner un titre:");

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Changer le thème?", "black", "white", "league", "blood", "sky", "beige", "simple", "night", "serif", "moon", "solarized"  }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabel16, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 236, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(comboSelectionTitre, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 248, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(comboSelectionTitre, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        jToggleButton2.setText("Ajouter un slide");
        ...
        jButton3.setText("Afficher dans le navigateur");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jToggleButton2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                    .add(btnClose, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                    .add(btnSave, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(18, 18, 18)
                .add(jToggleButton2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 49, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(18, 18, 18)
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        ...
        if (reply == JOptionPane.YES_OPTION)
        {           
            ImpressOpenedSlideEdit.setEditState(false);
                       
            savestate = true;                                             
            
            iProject.vide();
            
            iProject.setThemeName(null);
            
            iProject.setIprojectName(null);                         
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        String transformedText = brackets.doBrackets(n, selectedtext);
            
        jTextArea1.replaceSelection(transformedText);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ImpressOpenedSlideEdit.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void comboSelectionTitreFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_comboSelectionTitreFocusGained
/*                               
        if(iProject.newSlideList!=null || !iProject.newSlideList.isEmpty() ){
    ...
    }//GEN-LAST:event_comboSelectionTitreFocusGained

    private void comboSelectionTitreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboSelectionTitreActionPerformed
                                
        int ind  = comboSelectionTitre.getSelectedIndex();
        ...
        this.bg = iProject.getBg(ind);

        this.img = iProject.getImg(ind);
        
    }//GEN-LAST:event_comboSelectionTitreActionPerformed
    ...
    private void jToggleButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jToggleButton2MouseClicked
            ...
            fieldRotaX.setText("0");
            
            fieldRotaY.setText("0");
            
            fieldScale.setText("1");
                       
            fieldSlideTitle.setText("");
            
            this.bg = "";
            
            this.img = "";
            
            comboSelectionTitre.setVisible(false);
            
            String [] vide = new String[0];
            
            comboSelectionTitre.setModel(new javax.swing.DefaultComboBoxModel(vide));
            
            jLabel16.setVisible(false);
            
            JOptionPane.showMessageDialog(null, "Remplissez le slide et cliquer sur Enregistrer !");                        
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        //JOptionPane.showMessageDialog(null, iProject.getName(0)); 
        File indexfile = new File(iProject.desktop+"/Dys_projects/"+iProject.getName(0)+"/index.html");
            try {
                Desktop desk = Desktop.getDesktop();
                 if(indexfile.exists()) desk.open(indexfile);                                            
            } catch (IOException ex) {
                Logger.getLogger(ImpressSlideEdit.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private javax.swing.JComboBox comboSelectionTitre;
    ...
    private void setElements() {                  
        ...
        if(addingstate == false){
            int ind = comboSelectionTitre.getSelectedIndex();
            iProject.setId(ind, jTextField2.getText());
            iProject.setName(ind, iProject.iprojectName);
            iProject.setTitle(ind, fieldSlideTitle.getText());
            iProject.setText(ind, jTextArea1.getText());
            iProject.setTime(ind, "3000");
            if(jCheckBox1.isSelected())
            iProject.setPlay(ind,"true"); 
            else
                iProject.setPlay(ind,"false"); 
            iProject.setPosX(ind, fieldPosX.getText());
            iProject.setPosY(ind, fieldPosY.getText());
            iProject.setPosZ(ind, jTextField1.getText());
            iProject.setRotate(ind, fieldRotate.getText());
            iProject.setRotateX(ind, fieldRotaX.getText());
            iProject.setRotateY(ind, fieldRotaY.getText());
            iProject.setBg(ind, bg);
            iProject.setImg(ind, img);
            iProject.setScale(ind, fieldScale.getText());
            iProject.setTheme(ind, jComboBox4.getSelectedItem().toString());
        ...
        else if(addingstate == true )
        {
            ...
            int ind = iProject.slideIndexOf-1;
